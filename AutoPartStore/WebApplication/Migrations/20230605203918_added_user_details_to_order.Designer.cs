...
namespace WebApplication.Migrations
{
    ...
    [Migration("20230605203918_added_user_details_to_order")]
    partial class added_user_details_to_order
    {
            ...
            modelBuilder.Entity("WebApplication.Models.OrderItemModel", b =>
                {
                    ...
                    b.Property<Guid?>("OrderModelOrderGuid1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrderModelOrderGuid1");
            ...
            modelBuilder.Entity("WebApplication.Models.OrderItemModel", b =>
                {
                    ...
                    b.HasOne("WebApplication.Models.OrderModel", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderModelOrderGuid1");
                });
